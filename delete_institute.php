...
<html>
	...
	<body>
		...
		<?php 
			...
			<h2> Are you sure you want to delete <b>$name</b></h2>
			<span style=\"color:red;\">Caution: It will also delete all the journal details of respective institute. </span> 
			<p>
			<form action=\"process_delete.php\" method=\"post\">
			<input type=\"hidden\" value=\"$name\" name=\"name\" />
			<button class=\"btn btn-danger\">Yes</button>
			</form> <br>
			<a href=\"admin.php\"><button class=\"btn btn-default\">No</button></a>
			</p>
			</div>
			";
