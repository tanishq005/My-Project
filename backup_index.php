	...
	<body background="wall.jpg">
		...
		<div class="container">
			<div class="jumbotron">
				...
				<p> This is a website which enables you to know about the places where all the e resources around the colleges is located.</p>
				<form action="search.php" method="get">
					<input type="hidden" value="1" name="page">
					<div class="form-group">
						<label for="text" ><h3>Search E-Resources</h3></label><br>
						<input type="text" name="query"  class="form-control"  autofocus required="required">
						</div>
