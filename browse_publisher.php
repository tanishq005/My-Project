...
<html>
	...
	<body>
		...
		<center><h3> 
			...
			for($i=65;$i<91;$i++)
				{	
					printf("<a href=\"browse_search_publisher.php?token=$i \" target=\"browse\">%c\n</a>",$i);
				}	
			?>
		</h3></center>
		<iframe src="browse_search_publisher.php?token=65" height="500px" width="100%" name="browse" frameborder="0"></iframe>	
		</div>
