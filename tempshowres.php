...
<html>
	...
	<body>
		...
		<?php
			...
			echo " <div class=\"col-sm-6\"></div>  <div class=\"col-sm-6\"><table class=\"table table-hover table-striped \"> <tr><td>Title</td><td>City</td><td>Institute</td><td>Holdings</td><td>Last Update</td><td>Action</td></tr>" ;
